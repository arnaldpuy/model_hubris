...
# Institutional attachment to large models
...
```{r plot.legacy, dependson="legacy", fig.height=2.5, fig.width=2.5}
...
```{r legacy_institute, dependson="legacy", fig.height=4.7, fig.width=6, warning=FALSE}
...
```{r attachment_year, dependson="legacy", fig.height=2.8, fig.width=4}
...
```{r merge_attachment, dependson=c("attachment_year", "plot.legacy"), fig.height=2.5, fig.width=6}
